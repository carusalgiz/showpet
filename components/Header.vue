<template>
    <div class="header md sm" v-bind:class="{'short': scrolled}" id="header">
       <v-container class="d-md-flex d-lg-flex d-sm-none d-none align-center justify-space-between pa-2">
          ...
          <div class="contacts-col">
            <span>ХАБАРОВСК, УЛ.ДИКОПОЛЬЦЕВА 1; 08:00 − 20:00</span>
          </div>
          <div class="contacts-col">
      ...
      <v-container class="d-md-flex d-lg-flex d-sm-none d-none align-center justify-space-between header-bottom">
        ...
        <div class="d-flex menu-rows">
          ...
          <NuxtLink to="/blog"><div class="menu-col">
            <span>АКЦИИ</span>
          </div></NuxtLink>
        ...
        <div class="d-sm-flex" style="position: relative">
          <div v-if="!loggedIn" v-click-outside="clickOutside">
            <div class="menu-col">
          ...
          <div class="menu-col user d-flex flex-column align-end">
            ...
            <NuxtLink v-if="isStuff" to="/admin">
      ...
      <transition name="fade">
        <div class="catalog-block " v-show="menuOpen"  v-bind:class="{'short': scrolled}">
          <v-container class="d-md-flex d-lg-flex justify-space-around pa-10" @mouseenter="menuOpen = true" @mouseleave="menuOpen = false">
      ...
      >
        ...
        <div class="d-sm-flex" style="position: relative">
          ...
          <v-list-item class="custom-list-mobile mb-4" v-if="isStuff">
            <NuxtLink to="/admin">
        ...
        <v-list-item class="custom-list-mobile mb-4"><NuxtLink to="/blog"><div class="menu-item-mobile">
          <span>Акции</span>
...
<script>
    ...
    export default {
      ...
      mounted() {
        console.log(this);
        this.loggedIn = this.$store.state.loginState;
        this.cart = this.$store.state.cart != null ? this.$store.state.cart : [];
        this.isStuff = this.$store.state.isAdmin;
